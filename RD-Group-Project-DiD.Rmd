...
## 3rd row: Change in MEANs and SEs between both time points
  ...
  results.state.r3$group<- c("Control (Pennsylvania) - before", "Treatment (New Jersey) - before", "Difference - before", "Control (Pennsylvania) - after", "Treatment (New Jersey) - after", "Difference - after", "Control (Pennsylvania) - Change FTE", "Treatment (New Jersey) - Change FTE", "Difference - Change FTE") # add column with labels
...
results.low.r1 <- bind_rows(results.compare.r1, results.compare.r1[3,3]-results.compare.r1[1,3]) # difference between low and high
results.low.r1 <- bind_rows(results.low.r1, results.compare.r1[3,3]-results.compare.r1[2,3]) # difference between midrange and high
...
results.low.r2 <- bind_rows(results.compare.r2, results.compare.r2[3,3]-results.compare.r2[1,3]) # difference between low and high
results.low.r2 <- bind_rows(results.low.r2, results.compare.r2[3,3]-results.compare.r2[2,3]) # difference between midrange and high
...
results.low.r3 <- bind_rows(results.compare.r3, results.compare.r3[9,3]-results.compare.r3[7,3]) # difference between low and high
results.low.r3 <- bind_rows(results.low.r3, results.compare.r3[9,3]-results.compare.r3[8,3]) # difference between midrange and high
...
results.low.r4 <- bind_rows(results.compare.r4, results.compare.r4[9,3]-results.compare.r4[7,3]) # difference between low and high
results.low.r4 <- bind_rows(results.low.r4, results.compare.r4[9,3]-results.compare.r4[8,3]) # difference between midrange and high
...
results.low.r5 <- bind_rows(results.compare.r5, results.compare.r5[9,3]-results.compare.r5[7,3]) # difference between low and high
results.low.r5 <- bind_rows(results.low.r5, results.compare.r5[9,3]-results.compare.r5[8,3]) # difference between midrange and high
