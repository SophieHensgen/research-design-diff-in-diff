...
# Model (i)/Column 1: Base
  ...
  fit.c1 <- lm((y_full.emp.sec-y_full.emp) ~ d_nj,
             data = df2)
  summary(fit.c1)

# Model (ii)/Column 2: Controls Chain/Ownership
  fit.c2 <- lm((y_full.emp.sec-y_full.emp) ~ 
...
# then linear model/regression
  ...
  fit.c3 <- lm((y_full.emp.sec-y_full.emp) ~ 
               d_ini.wage.gap, 
             data = df2)
  summary(fit.c3)
...
# Model (iv)/Column 4: Initial Wage gap - Controls Chain/Ownership
  ...
  fit.c4 <- lm((y_full.emp.sec-y_full.emp) ~ 
...
# Model (iv)/Column 4: Initial Wage gap - Controls Chain/Ownership + Regions 
  ...
  fit.c5 <- lm((y_full.emp.sec-y_full.emp) ~ 
