...
df2$fte.0 <- df2$y_fte.before
df2$fte.1 <- df2$y_fte.after
...
data_long <- gather(df2, time, FTE, fte.0:fte.1, factor_key=TRUE)

data_long$time <- gsub("fte.0", 0, data_long$time)
data_long$time <- gsub("fte.1", 1, data_long$time)
data_long
